...
if __name__ == "__main__":
    ...
    parser.add_argument("--method", type=str, default="dpo-cutoff-2")
    ...
    sft_file = f"{args.output_dir}/{args.dataset}/{args.model_id}_train_sft-cutoff-{int(args.threshold)}.json"
