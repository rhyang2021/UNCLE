...
if __name__ == "__main__":
    ...
    if 'llama3-8b' in args.model_id:
        if args.method == "logu-sft":
            model_name = "/apdcephfs_qy3/share_301372554/share_info/ruihanyang/long_uncertainty_express/models/uncertain-llama3-8b-dpo-cutoff-2-ds20000-epoch3"
        elif args.method == "logu-dpo":
            model_name = "/apdcephfs_qy3/share_301372554/share_info/ruihanyang/long_uncertainty_express/models/uncertain-llama3-8b-sft-cutoff-2"
        else:
        ...
        if args.method == "logu-dpo":
            model_name = "/apdcephfs_qy3/share_301372554/share_info/ruihanyang/long_uncertainty_express/models/uncertain-mistral-7b-dpo-cutoff-2-ds20000-epoch3"
        elif args.method == "logu-sft":
            model_name = "/apdcephfs_qy3/share_301372554/share_info/ruihanyang/long_uncertainty_express/models/uncertain-mistral-7b-sft-cutoff-2"
        else:
    ...
    for item in tqdm(data, desc="entity"):
        ...
        for _ in range(args.repeat):
            ...
            long_answer = agent.generate(prompt=user_prompt)
